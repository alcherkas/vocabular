...
8. **Write a retrospective** — append to [`docs/retrospectives.md`](docs/retrospectives.md) (see format there). **Do NOT append raw retros to `AGENTS.md`** — this file contains only actionable guidance derived by the Reflection Agent.
...
| `docs/retrospectives.md` | **All agents** (append-only) | Append only — this is the ONLY file for raw retro content |
| `AGENTS.md` | **Reflection Agent only** | All others: read-only; **do NOT append retros here** |
